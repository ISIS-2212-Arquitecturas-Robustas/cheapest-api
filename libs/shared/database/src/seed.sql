...
('pro11111-1111-1111-1111-111111111111', 'Promoción Producto 1', 20.00, 'cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', '["bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb"]', NOW() - INTERVAL '30 days', NOW() + INTERVAL '30 days', 100, NOW(), NOW()),
('pro22222-2222-2222-2222-222222222222', 'Promoción Producto 2', 12.00, 'cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaab', '["bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb", "bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbc"]', NOW() - INTERVAL '30 days', NOW() + INTERVAL '30 days', 50, NOW(), NOW());

-- Pedidos
INSERT INTO pedidos (id, identificador, "tiendaId", "fechaHoraCreacion", "montoTotal", "monedaId", estado, "createdAt", "updatedAt") VALUES
('ped11111-1111-1111-1111-111111111111', 'PED-001', 'bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb', '2026-02-03 10:00:00', 45.50, 'cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'creado', NOW(), NOW()),
('ped22222-2222-2222-2222-222222222222', 'PED-002', 'bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbc', '2026-02-03 11:00:00', 75.75, 'cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'aprobado', NOW(), NOW());
...
('ip111111-1111-1111-1111-111111111111', 'ped11111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', 1, 25.50, 0.00, 'cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'LOTE001', '2026-12-31', NOW(), NOW()),
('ip222222-2222-2222-2222-222222222222', 'ped11111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaab', 1, 20.00, 0.00, 'cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'LOTE002', '2026-12-31', NOW(), NOW()),
('ip333333-3333-3333-3333-333333333333', 'ped22222-2222-2222-2222-222222222222', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', 2, 25.50, 0.00, 'cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'LOTE003', '2026-12-31', NOW(), NOW()),
('ip444444-4444-4444-4444-444444444444', 'ped22222-2222-2222-2222-222222222222', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaad', 1, 45.99, 0.00, 'cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'LOTE004', '2026-12-31', NOW(), NOW());
...
('not11111-1111-1111-1111-111111111111', 'ped11111-1111-1111-1111-111111111111', 'NC-001', '2026-02-04', 'productoVencido', 5.50, 'cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'Producto vencido en entrega', NOW(), NOW());
